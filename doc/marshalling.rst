...
flask-restplus-udata provides an easy way to control what data you actually render in
...
.. code-block:: python
    ...
    from flask_restplus_udata import Resource, fields
...
flask-restplus-udata includes a special field, :class:`fields.Url`,
...
.. code-block:: python
    ...
    >>> from flask_restplus_udata import fields, marshal
    >>> import json
    >>>
...
.. code-block:: python
    ...
    >>> from flask_restplus_udata import Model, fields, marshal_with
    >>> import json
    >>> model = Model('Model', {
    ...     'name': fields.String,
