...
.. warning ::
    ...
    The whole request parser part of flask-restplus-udata is slated for removal and
...
flask-restplus-udata's request parsing interface, :mod:`reqparse`,
...
The :mod:`~flask_restplus_udata.inputs` module provides some common type handling like:
...
See the :mod:`~flask_restplus_udata.inputs` documentation for full list of available inputs.
